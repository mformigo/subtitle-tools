 ...
 * Generated for Laravel 5.5.0 on 2017-08-31.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function fileGroupTool($routeName, $controller, $slug)
        {
            return \Illuminate\Routing\Router::fileGroupTool($routeName, $controller, $slug);
        }
