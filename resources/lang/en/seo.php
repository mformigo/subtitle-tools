...
//---------------60-characters----'############################################################'---------------------------
    ...
    'title.convertToUtf8'      => 'Convert text files to UTF-8: easy online encoding fix | Subtitle Tools',
...
//--------------160-characters----------'################################################################################################################################################################'---------------------------
    ...
    'description.convertToPlainText' => 'Online tool that extracts text from subtitle files. Create a movie transcript by removing all timestamps and formatting from subtitles. Supports srt, ass, ssa, smi and sub formats.',
    'description.convertToUtf8'      => 'Easily convert text or subtitle files to UTF-8. This tool automatically detects the encoding and converts it to UTF-8. Supports all text files (txt, srt, ascii, ansi).',
    ...
    'description.shift'              => 'Permanently synchronize subtitles online for free. Supports srt, ass, ssa and smi. Automatically adjust subtitle timings by shifting them earlier or later',
    'description.shiftPartial'       => 'Easy online tool for shifting multiple parts in a subtitle file. Only resync specific sections of a movies subtitles. Supports srt, ass and ssa files',
    ...
    'keywords.convertToSrt'    => 'convert to srt, subtitles to srt, ass to srt, ssa to srt, microdvd, smi to srt, ass2srt, ssa2srt, smi2srt, online, free, converter, conversion, subtitles, windows, mac, linux, freeware',
    'keywords.convertToPlainText' => 'convert, plain text, transcript, timestamps, srt, ass, ssa, smi, microdvd, sub, learn, subtitle, subtitles, extract',
    'keywords.convertToUtf8'   => 'subtitle, subtitles, srt, ass, txt, utf-8, encoding, file, files, text, textfile, convert, ascii, plain, ansi, online',
    ...
    'keywords.shift'           => 'sync, resync, shift, shifter, online, free, tool, srt, ass, ssa, smi, fix subtitle, synchronizer, permanently, permanent, adjust, vlc, timing',
    'keywords.shiftPartial'    => 'sync, resync, shift, shifter, online, free, tool, srt, ass, ssa, smi, fix subtitle, synchronizer, multi, partial, permanent, adjust, vlc, timing',
